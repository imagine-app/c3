...
// changes which were implemented in Firefox 43 and Chrome 46.
    ...
    (function () {
        if (!("SVGPathSeg" in window)) {
            ...
            Object.defineProperty(window.SVGPathSegCurvetoCubicAbs.prototype, "x3", {
                get: function get() {
                    return this._x3;
                }, set: function set(x3) {
                    this._x3 = x3;
            ...
            Object.defineProperty(window.SVGPathSegCurvetoCubicAbs.prototype, "y3", {
                get: function get() {
                    return this._y3;
                }, set: function set(y3) {
                    this._y3 = y3;
            ...
            Object.defineProperty(window.SVGPathSegCurvetoCubicRel.prototype, "x3", {
                get: function get() {
                    return this._x3;
                }, set: function set(x3) {
                    this._x3 = x3;
            ...
            Object.defineProperty(window.SVGPathSegCurvetoCubicRel.prototype, "y3", {
                get: function get() {
                    return this._y3;
                }, set: function set(y3) {
                    this._y3 = y3;
            ...
            Object.defineProperty(window.SVGPathSegCurvetoCubicSmoothAbs.prototype, "x3", {
                get: function get() {
                    return this._x3;
                }, set: function set(x3) {
                    this._x3 = x3;
            ...
            Object.defineProperty(window.SVGPathSegCurvetoCubicSmoothAbs.prototype, "y3", {
                get: function get() {
                    return this._y3;
                }, set: function set(y3) {
                    this._y3 = y3;
            ...
            Object.defineProperty(window.SVGPathSegCurvetoCubicSmoothRel.prototype, "x3", {
                get: function get() {
                    return this._x3;
                }, set: function set(x3) {
                    this._x3 = x3;
            ...
            Object.defineProperty(window.SVGPathSegCurvetoCubicSmoothRel.prototype, "y3", {
                get: function get() {
                    return this._y3;
                }, set: function set(y3) {
                    this._y3 = y3;
                    ...
                    switch (command) {
                        ...
                        case window.SVGPathSeg.PATHSEG_CURVETO_CUBIC_REL:
                            var points = {
                                ...
                                x3: this._parseNumber(),
                                y3: this._parseNumber(),
                                x: this._parseNumber(),
                                y: this._parseNumber()
                            };
...
// TODO: fix
    ...
    c3_chart_internal_fn.updateLegend = function (targetIds, options, transitions) {
        ...
        var xForLegend, xForLegendText, xForLegendRect, yForLegend, yForLegendText, yForLegendRect, x1ForLegendTile,
            x2ForLegendTile, x3ForLegendTile, yForLegendTile;
        var paddingTop = 4,
            paddingRight = 10,
            maxWidth = 0,
            maxHeight = 0,
        ...
        } : $$.color).attr('x1', x1ForLegendTile).attr('y1', yForLegendTile).attr('x2', x2ForLegendTile).attr('y2', yForLegendTile).attr('x3', x3ForLegendTile).attr('y3', yForLegendTile);
    ...
    c3_chart_internal_fn.regionX = function (d) {
        var $$ = this,
            config = $$.config,
            xPos,
            yScale = d.axis === 'y' ? $$.y : d.axis === 'y2' ? $$.y2 : $$.y3;
